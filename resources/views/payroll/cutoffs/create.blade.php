<x-app-layout>
    <x-slot name="title">New Payroll Cutoff</x-slot>

    <div class="max-w-xl">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <h2 class="text-base font-semibold text-gray-800 mb-5">Cutoff Details</h2>
            <form method="POST" action="{{ route('payroll.cutoffs.store') }}">
                @csrf
