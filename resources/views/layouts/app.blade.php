...
<div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            @if($user->hasPermission('announcements'))
            <x-sidebar-link :href="route('announcements.index')" :active="request()->routeIs('announcements.*')" @click="sidebarOpen = false">
                <x-slot name="icon">
            ...
            <x-sidebar-link :href="route('reports.absences')" :active="request()->routeIs('reports.absences')" @click="sidebarOpen = false">
                <x-slot name="icon">
            ...
            <x-sidebar-link :href="route('reports.thirteenth-month')" :active="request()->routeIs('reports.thirteenth-month')" @click="sidebarOpen = false">
                <x-slot name="icon">
