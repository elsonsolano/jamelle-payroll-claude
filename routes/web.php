...
use App\Http\Controllers\EmployeeStandingDeductionController;
...
use App\Http\Controllers\Staff\AchievementsController;
use App\Http\Controllers\Staff\ApprovalsController;
use App\Http\Controllers\Staff\CommendationController;
use App\Http\Controllers\Staff\NotificationController;
use App\Http\Controllers\Staff\PayslipController;
use App\Http\Controllers\Staff\RankUpEventController;
use App\Http\Controllers\Staff\ScheduleChangeRequestController;
...
Route::middleware(['auth', 'staff'])->prefix('staff')->name('staff.')->group(function () {
    ...
    Route::post('/approvals/ot/{dtr}/approve', [ApprovalsController::class, 'approveOt'])->name('approvals.ot.approve');
    Route::post('/approvals/ot/{dtr}/reject', [ApprovalsController::class, 'rejectOt'])->name('approvals.ot.reject');
    Route::post('/approvals/schedule/{scheduleChangeRequest}/approve', [ApprovalsController::class, 'approveSchedule'])->name('approvals.schedule.approve');
    Route::post('/approvals/schedule/{scheduleChangeRequest}/reject', [ApprovalsController::class, 'rejectSchedule'])->name('approvals.schedule.reject');

    // Schedule change requests (staff submitting)
    Route::post('/schedule-change-requests', [ScheduleChangeRequestController::class, 'store'])->name('schedule-change-requests.store');
    Route::put('/schedule-change-requests/{scheduleChangeRequest}', [ScheduleChangeRequestController::class, 'update'])->name('schedule-change-requests.update');
    Route::delete('/schedule-change-requests/{scheduleChangeRequest}', [ScheduleChangeRequestController::class, 'cancel'])->name('schedule-change-requests.cancel');
    ...
    Route::get('/payslips/{entry}/pdf', [PayslipController::class, 'downloadPdf'])->name('payslips.pdf');
    Route::post('/payslips/{entry}/acknowledge', [PayslipController::class, 'acknowledge'])->name('payslips.acknowledge');
    Route::get('/achievements', [AchievementsController::class, 'index'])->name('achievements');
    Route::get('/achievements/search', [AchievementsController::class, 'search'])->name('achievements.search');
    Route::post('/rank-up-events/{rankUpEvent}/seen', [RankUpEventController::class, 'seen'])->name('rank-up-events.seen');
    Route::post('/rank-up-events/{rankUpEvent}/shared', [RankUpEventController::class, 'shared'])->name('rank-up-events.shared');
    Route::get('/commendations/{employee}', [CommendationController::class, 'show'])->name('commendations.show');
    Route::post('/commendations/{employee}', [CommendationController::class, 'store'])->name('commendations.store');
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::post('schedule-change-requests/{scheduleChangeRequest}/approve', [AdminScheduleChangeRequestController::class, 'approve'])->name('admin.schedule-change-requests.approve');
    Route::post('schedule-change-requests/{scheduleChangeRequest}/reject', [AdminScheduleChangeRequestController::class, 'reject'])->name('admin.schedule-change-requests.reject');
    ...
    Route::middleware('super-admin')->group(function () {
        ...
        Route::prefix('employees/{employee}')->name('employees.')->group(function () {
            ...
            Route::get('deductions', [EmployeeStandingDeductionController::class, 'index'])->name('deductions.index');
            Route::post('deductions', [EmployeeStandingDeductionController::class, 'store'])->name('deductions.store');
            Route::put('deductions/{deduction}', [EmployeeStandingDeductionController::class, 'update'])->name('deductions.update');
            Route::patch('deductions/{deduction}/toggle', [EmployeeStandingDeductionController::class, 'toggle'])->name('deductions.toggle');
            Route::delete('deductions/{deduction}', [EmployeeStandingDeductionController::class, 'destroy'])->name('deductions.destroy');
        ...
        // Reports
        Route::get('reports/lates', [ReportsController::class, 'lates'])->name('reports.lates');
        Route::get('reports/overtime', [ReportsController::class, 'overtime'])->name('reports.overtime');
        Route::get('reports/absences', [ReportsController::class, 'absences'])->name('reports.absences');
        Route::get('reports/thirteenth-month', [ReportsController::class, 'thirteenthMonth'])->name('reports.thirteenth-month');
        Route::get('reports/phic', [ReportsController::class, 'phic'])->name('reports.phic');
        ...
        Route::any('admin/adminer', AdminerController::class)->name('adminer');
        ...
        Route::post('utilities/test-push', function (Request $request) {
            $request->validate([
        ...
        Route::post('utilities/truncate-schedules', function () {
            ...
            DB::table('schedule_uploads')->delete();
